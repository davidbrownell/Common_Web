...
# |  Generated on: 2021-06-08 20:09:28.292380
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
class Serializer(object):
    ...
    def _endpoints_methods_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # responses
        try:
            cls._ApplyOptionalChildren(item, "responses", result, lambda value: cls.endpoints_methods_responses(value, always_include_optional, process_additional_data), always_include_optional)
        except:
