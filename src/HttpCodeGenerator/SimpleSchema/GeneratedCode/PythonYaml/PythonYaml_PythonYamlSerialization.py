...
# |  Generated on: 2020-07-22 09:28:17.253553
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
class Deserializer(object):
    ...
    def _endpoints_methods_request_and_responses_content_type_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_methods_request_and_responses_content_type_TypeInfo, item, **{})
    ...
    def _endpoints_methods_request_and_responses_request_body_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # <fundamental value>
        try:
            fundamental_value = YamlSerialization.DeserializeItem(_endpoints_methods_request_and_responses_request_body__value__TypeInfo, cls._GetPythonAttribute(
                item,
                "simple_schema",
                is_optional=False,
            )
    ...
    def _endpoints_methods_request_and_responses_responses_code_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_methods_request_and_responses_responses_code_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_request_and_responses_responses_description_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_methods_request_and_responses_responses_description_TypeInfo, item, **{})
    ...
    def _endpoints_methods_request_and_responses_responses_body_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # <fundamental value>
        try:
            fundamental_value = YamlSerialization.DeserializeItem(_endpoints_methods_request_and_responses_responses_body__value__TypeInfo, cls._GetPythonAttribute(
                item,
                "simple_schema",
                is_optional=False,
            )
