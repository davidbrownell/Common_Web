...
# |  Generated on: 2020-07-30 18:23:18.252156
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
def Deserialize_simple_schema_content(
    ...
    """Deserializes 'simple_schema_content' from a YAML object to a python object"""
...
class Deserializer(object):
    ...
    def _summary_Item(cls, item):
        return YamlSerialization.DeserializeItem(_summary_TypeInfo, item, **{})
    ...
    def _simple_schema_content_Item(cls, item):
        return YamlSerialization.DeserializeItem(_simple_schema_content_TypeInfo, item, **{})
    ...
    def _endpoints_methods_requests_content_type_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_methods_requests_content_type_TypeInfo, item, **{})
    ...
    def _endpoints_methods_requests_body_Item(cls, item, always_include_optional, process_additional_data):
        # <fundamental value>
        try:
            fundamental_value = YamlSerialization.DeserializeItem(_endpoints_methods_requests_body__value__TypeInfo, cls._GetPythonAttribute(
                item,
                "simple_schema",
                is_optional=False,
            )
    ...
    def _endpoints_methods_responses_code_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_methods_responses_code_TypeInfo, item, **{})
    ...
    def _endpoints_methods_responses_contents_content_type_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_methods_responses_contents_content_type_TypeInfo, item, **{})
    ...
    def _endpoints_methods_responses_contents_body_Item(cls, item, always_include_optional, process_additional_data):
        # <fundamental value>
        try:
            fundamental_value = YamlSerialization.DeserializeItem(_endpoints_methods_responses_contents_body__value__TypeInfo, cls._GetPythonAttribute(
                item,
                "simple_schema",
                is_optional=False,
            )
