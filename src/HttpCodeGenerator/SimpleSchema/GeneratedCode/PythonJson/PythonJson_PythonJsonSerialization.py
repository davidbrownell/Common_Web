...
# |  Generated on: 2020-07-18 10:44:28.315296
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
class Deserializer(object):
    ...
    def _context_Item(cls, item):
        return JsonSerialization.DeserializeItem(_context_TypeInfo, item, **{})
    ...
    def _type_description_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # <fundamental value>
        try:
            fundamental_value = JsonSerialization.DeserializeItem(_type_description__value__TypeInfo, cls._GetPythonAttribute(
                item,
                "simple_schema",
                is_optional=False,
            )
    ...
    def _type_description_description_Item(cls, item):
        return JsonSerialization.DeserializeItem(_type_description_description_TypeInfo, item, **{})
    ...
    def _type_descriptions_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # <fundamental value>
        try:
            fundamental_value = JsonSerialization.DeserializeItem(_type_descriptions__value__TypeInfo, cls._GetPythonAttribute(
                item,
                "simple_schema",
                is_optional=False,
            )
    ...
    def _type_descriptions_name_Item(cls, item):
        return JsonSerialization.DeserializeItem(_type_descriptions_name_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _type_descriptions_description_Item(cls, item):
        return JsonSerialization.DeserializeItem(_type_descriptions_description_TypeInfo, item, **{})
    ...
    def _endpoints_uri_Item(cls, item):
        return JsonSerialization.DeserializeItem(_endpoints_uri_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_description_Item(cls, item):
        return JsonSerialization.DeserializeItem(_endpoints_description_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_group_Item(cls, item):
        return JsonSerialization.DeserializeItem(_endpoints_group_TypeInfo, item, **{})
    ...
    def _endpoints_methods_verb_Item(cls, item):
        return JsonSerialization.DeserializeItem(_endpoints_methods_verb_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_summary_Item(cls, item):
        return JsonSerialization.DeserializeItem(_endpoints_methods_summary_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_description_Item(cls, item):
        return JsonSerialization.DeserializeItem(_endpoints_methods_description_TypeInfo, item, **{})
    ...
    def _endpoints_methods_request_and_response_content_type_Item(cls, item):
        return JsonSerialization.DeserializeItem(_endpoints_methods_request_and_response_content_type_TypeInfo, item, **{})
    ...
    def _endpoints_methods_request_and_response_request_body_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # <fundamental value>
        try:
            fundamental_value = JsonSerialization.DeserializeItem(_endpoints_methods_request_and_response_request_body__value__TypeInfo, cls._GetPythonAttribute(
                item,
                "simple_schema",
                is_optional=False,
            )
    ...
    def _endpoints_methods_request_and_response_responses_code_Item(cls, item):
        return JsonSerialization.DeserializeItem(_endpoints_methods_request_and_response_responses_code_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_request_and_response_responses_description_Item(cls, item):
        return JsonSerialization.DeserializeItem(_endpoints_methods_request_and_response_responses_description_TypeInfo, item, **{})
    ...
    def _endpoints_methods_request_and_response_responses_body_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # <fundamental value>
        try:
            fundamental_value = JsonSerialization.DeserializeItem(_endpoints_methods_request_and_response_responses_body__value__TypeInfo, cls._GetPythonAttribute(
                item,
                "simple_schema",
                is_optional=False,
            )
