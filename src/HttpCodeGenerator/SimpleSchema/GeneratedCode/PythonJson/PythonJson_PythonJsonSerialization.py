...
# |  Generated on: 2020-07-30 18:23:14.937635
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
class Deserializer(object):
    ...
    def _description_Item(cls, item):
        return JsonSerialization.DeserializeItem(_description_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _summary_Item(cls, item):
        return JsonSerialization.DeserializeItem(_summary_TypeInfo, item, **{})
    ...
    def _simple_schema_content_Item(cls, item):
        return JsonSerialization.DeserializeItem(_simple_schema_content_TypeInfo, item, **{})
    ...
    def _endpoints_methods_requests_content_type_Item(cls, item):
        return JsonSerialization.DeserializeItem(_endpoints_methods_requests_content_type_TypeInfo, item, **{})
    ...
    def _endpoints_methods_requests_body_Item(cls, item, always_include_optional, process_additional_data):
        # <fundamental value>
        try:
            fundamental_value = JsonSerialization.DeserializeItem(_endpoints_methods_requests_body__value__TypeInfo, cls._GetPythonAttribute(
                item,
                "simple_schema",
                is_optional=False,
            )
    ...
    def _endpoints_methods_responses_code_Item(cls, item):
        return JsonSerialization.DeserializeItem(_endpoints_methods_responses_code_TypeInfo, item, **{})
    ...
    def _endpoints_methods_responses_contents_content_type_Item(cls, item):
        return JsonSerialization.DeserializeItem(_endpoints_methods_responses_contents_content_type_TypeInfo, item, **{})
    ...
    def _endpoints_methods_responses_contents_body_Item(cls, item, always_include_optional, process_additional_data):
        # <fundamental value>
        try:
            fundamental_value = JsonSerialization.DeserializeItem(_endpoints_methods_responses_contents_body__value__TypeInfo, cls._GetPythonAttribute(
                item,
                "simple_schema",
                is_optional=False,
            )
