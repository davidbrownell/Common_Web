...
# |  Generated on: 2020-07-18 10:44:30.139448
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
class Deserializer(object):
    ...
    def _endpoints_methods_request_and_response_content_type_Item(cls, item):
        return XmlSerialization.DeserializeItem(_endpoints_methods_request_and_response_content_type_TypeInfo, item, **{})
    ...
    def _endpoints_methods_request_and_response_request_body_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # <fundamental value>
        try:
            fundamental_value = XmlSerialization.DeserializeItem(_endpoints_methods_request_and_response_request_body__value__TypeInfo, cls.GetText(item), **{})
        except:
            _DecorateActiveException("value type")
    ...
    def _endpoints_methods_request_and_response_responses_code_Item(cls, item):
        return XmlSerialization.DeserializeItem(_endpoints_methods_request_and_response_responses_code_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_request_and_response_responses_description_Item(cls, item):
        return XmlSerialization.DeserializeItem(_endpoints_methods_request_and_response_responses_description_TypeInfo, item, **{})
    ...
    def _endpoints_methods_request_and_response_responses_body_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # <fundamental value>
        try:
            fundamental_value = XmlSerialization.DeserializeItem(_endpoints_methods_request_and_response_responses_body__value__TypeInfo, cls.GetText(item), **{})
        except:
            _DecorateActiveException("value type")
