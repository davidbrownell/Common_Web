...
# |  Generated on: 2020-07-18 10:44:31.952385
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
def Deserialize_endpoints(
    ...
    """Deserializes 'endpoints' from a YAML object to a python object"""
...
# |
# ----------------------------------------------------------------------
endpoints_TypeInfo                                                          = PythonCodeVisitor.LoadTypeInfo(ClassTypeInfo(OrderedDict([ ( "uri", StringTypeInfo(min_length=1) ), ( "variables", ClassTypeInfo(OrderedDict([ ( "name", StringTypeInfo(min_length=1) ) ]), require_exact_match=True, arity=Arity.FromString('*')) ), ( "description", StringTypeInfo(min_length=1, arity=Arity.FromString('?')) ), ( "group", StringTypeInfo(min_length=1, arity=Arity.FromString('?')) ), ( "context", StringTypeInfo(min_length=1, arity=Arity.FromString('?')) ), ( "methods", ClassTypeInfo(OrderedDict([ ( "verb", EnumTypeInfo([ 'POST', 'GET', 'PUT', 'PATCH', 'DELETE', 'OPTIONS', 'HEAD', 'TRACE', 'CONNECT', ]) ), ( "summary", StringTypeInfo(min_length=1, max_length=120, arity=Arity.FromString('?')) ), ( "description", StringTypeInfo(min_length=1, arity=Arity.FromString('?')) ), ( "context", StringTypeInfo(min_length=1, arity=Arity.FromString('?')) ), ( "request_and_response", ClassTypeInfo(OrderedDict([ ( "content_type", StringTypeInfo(min_length=1) ), ( "context", StringTypeInfo(min_length=1, arity=Arity.FromString('?')) ), ( "request", ClassTypeInfo(OrderedDict([ ( "headers", ClassTypeInfo(OrderedDict([ ( "name", 3 ) ]), require_exact_match=True, arity=Arity.FromString('*')) ), ( "query_items", ClassTypeInfo(OrderedDict([ ( "name", 3 ) ]), require_exact_match=True, arity=Arity.FromString('*')) ), ( "form_items", ClassTypeInfo(OrderedDict([ ( "name", 3 ) ]), require_exact_match=True, arity=Arity.FromString('*')) ), ( "body", ClassTypeInfo(OrderedDict([ ( "description", StringTypeInfo(min_length=1, arity=Arity.FromString('?')) ), ( "simple_schema", StringTypeInfo(min_length=1) ) ]), require_exact_match=True, arity=Arity.FromString('?')) ) ]), require_exact_match=True) ), ( "responses", ClassTypeInfo(OrderedDict([ ( "code", IntTypeInfo(min=0, max=99999) ), ( "description", StringTypeInfo(min_length=1, arity=Arity.FromString('?')) ), ( "context", StringTypeInfo(min_length=1, arity=Arity.FromString('?')) ), ( "headers", ClassTypeInfo(OrderedDict([ ( "name", 3 ) ]), require_exact_match=True, arity=Arity.FromString('*')) ), ( "body", ClassTypeInfo(OrderedDict([ ( "description", 20 ), ( "simple_schema", 21 ) ]), require_exact_match=True, arity=Arity.FromString('?')) ) ]), require_exact_match=True, arity=Arity.FromString('+')) ) ]), require_exact_match=True, arity=Arity.FromString('+')) ) ]), require_exact_match=True, arity=Arity.FromString('*')) ), ( "children", ClassTypeInfo(OrderedDict([ ( "uri", 1 ), ( "variables", 2 ), ( "description", 4 ), ( "group", 5 ), ( "context", 6 ), ( "methods", 7 ), ( "children", 28 ) ]), require_exact_match=True, arity=Arity.FromString('*')) ) ]), require_exact_match=True, arity=Arity.FromString('+')))
...
_endpoints_TypeInfo_Contents                                                = OrderedDict([("uri", GenericTypeInfo()), ("variables", GenericTypeInfo(arity=Arity.FromString('*'))), ("description", GenericTypeInfo(arity=Arity.FromString('?'))), ("group", GenericTypeInfo(arity=Arity.FromString('?'))), ("context", GenericTypeInfo(arity=Arity.FromString('?'))), ("methods", GenericTypeInfo(arity=Arity.FromString('*'))), ("children", GenericTypeInfo(arity=Arity.FromString('*')))])
_endpoints_methods_TypeInfo_Contents                                        = OrderedDict([("verb", GenericTypeInfo()), ("summary", GenericTypeInfo(arity=Arity.FromString('?'))), ("description", GenericTypeInfo(arity=Arity.FromString('?'))), ("context", GenericTypeInfo(arity=Arity.FromString('?'))), ("request_and_response", GenericTypeInfo(arity=Arity.FromString('+')))])
_endpoints_methods_request_and_response_TypeInfo_Contents                   = OrderedDict([("content_type", GenericTypeInfo()), ("context", GenericTypeInfo(arity=Arity.FromString('?'))), ("request", GenericTypeInfo()), ("responses", GenericTypeInfo(arity=Arity.FromString('+')))])
_endpoints_methods_request_and_response_request_TypeInfo_Contents           = OrderedDict([("headers", GenericTypeInfo(arity=Arity.FromString('*'))), ("query_items", GenericTypeInfo(arity=Arity.FromString('*'))), ("form_items", GenericTypeInfo(arity=Arity.FromString('*'))), ("body", GenericTypeInfo(arity=Arity.FromString('?')))])
_endpoints_methods_request_and_response_responses_TypeInfo_Contents         = OrderedDict([("code", GenericTypeInfo()), ("description", GenericTypeInfo(arity=Arity.FromString('?'))), ("context", GenericTypeInfo(arity=Arity.FromString('?'))), ("headers", GenericTypeInfo(arity=Arity.FromString('*'))), ("body", GenericTypeInfo(arity=Arity.FromString('?')))])
...
_endpoints_methods_request_and_response_TypeInfo                            = AnyOfTypeInfo([ClassTypeInfo(_endpoints_methods_request_and_response_TypeInfo_Contents, require_exact_match=False), DictTypeInfo(_endpoints_methods_request_and_response_TypeInfo_Contents, require_exact_match=False)], arity=Arity.FromString('+'))
_endpoints_methods_request_and_response_content_type_TypeInfo               = StringTypeInfo(min_length=1)
_endpoints_methods_request_and_response_request_TypeInfo                    = AnyOfTypeInfo([ClassTypeInfo(_endpoints_methods_request_and_response_request_TypeInfo_Contents, require_exact_match=False), DictTypeInfo(_endpoints_methods_request_and_response_request_TypeInfo_Contents, require_exact_match=False)])
_endpoints_methods_request_and_response_request_body_TypeInfo               = AnyOfTypeInfo([ClassTypeInfo(_type_description_TypeInfo_Contents, require_exact_match=False), DictTypeInfo(_type_description_TypeInfo_Contents, require_exact_match=False)], arity=Arity.FromString('?'))
_endpoints_methods_request_and_response_request_body__value__TypeInfo       = StringTypeInfo(min_length=1)
_endpoints_methods_request_and_response_responses_TypeInfo                  = AnyOfTypeInfo([ClassTypeInfo(_endpoints_methods_request_and_response_responses_TypeInfo_Contents, require_exact_match=False), DictTypeInfo(_endpoints_methods_request_and_response_responses_TypeInfo_Contents, require_exact_match=False)], arity=Arity.FromString('+'))
_endpoints_methods_request_and_response_responses_code_TypeInfo             = IntTypeInfo(min=0, max=99999)
_endpoints_methods_request_and_response_responses_description_TypeInfo      = StringTypeInfo(min_length=1, arity=Arity.FromString('?'))
_endpoints_methods_request_and_response_responses_body_TypeInfo             = AnyOfTypeInfo([ClassTypeInfo(_type_description_TypeInfo_Contents, require_exact_match=False), DictTypeInfo(_type_description_TypeInfo_Contents, require_exact_match=False)], arity=Arity.FromString('?'))
_endpoints_methods_request_and_response_responses_body__value__TypeInfo     = StringTypeInfo(min_length=1)
...
class Deserializer(object):
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def endpoints_methods_request_and_response(cls, items, always_include_optional, process_additional_data):
        if items in [DoesNotExist, None, []]:
            _endpoints_methods_request_and_response_TypeInfo.ValidateArity(None)
            return DoesNotExist
        ...
        for this_index, this_item in enumerate(items or []):
            try:
                results.append(cls._endpoints_methods_request_and_response_Item(this_item, always_include_optional, process_additional_data))
            except:
                _DecorateActiveException("Index {}".format(this_index))
        ...
        if not process_additional_data:
            _endpoints_methods_request_and_response_TypeInfo.ValidateArity(results)

        return results

    # ----------------------------------------------------------------------
    @classmethod
    def endpoints_methods_request_and_response_content_type(cls, item):
        if item in [DoesNotExist, None]:
            _endpoints_methods_request_and_response_content_type_TypeInfo.ValidateArity(None)
            return DoesNotExist

        result = cls._endpoints_methods_request_and_response_content_type_Item(item)

        _endpoints_methods_request_and_response_content_type_TypeInfo.ValidateArity(result)

        return result

    # ----------------------------------------------------------------------
    @classmethod
    def endpoints_methods_request_and_response_context(cls, item):
        return cls.endpoints_methods_context(item)

    # ----------------------------------------------------------------------
    @classmethod
    def endpoints_methods_request_and_response_request(cls, item, always_include_optional, process_additional_data):
        if item in [DoesNotExist, None]:
            _endpoints_methods_request_and_response_request_TypeInfo.ValidateArity(None)
            return DoesNotExist

        result = cls._endpoints_methods_request_and_response_request_Item(item, always_include_optional, process_additional_data)

        if not process_additional_data:
            _endpoints_methods_request_and_response_request_TypeInfo.ValidateArity(result)

        return result

    # ----------------------------------------------------------------------
    @classmethod
    def endpoints_methods_request_and_response_request_headers(cls, items, always_include_optional, process_additional_data):
        return cls.type_descriptions(items, always_include_optional, process_additional_data)

    # ----------------------------------------------------------------------
    @classmethod
    def endpoints_methods_request_and_response_request_query_items(cls, items, always_include_optional, process_additional_data):
        return cls.type_descriptions(items, always_include_optional, process_additional_data)

    # ----------------------------------------------------------------------
    @classmethod
    def endpoints_methods_request_and_response_request_form_items(cls, items, always_include_optional, process_additional_data):
        return cls.type_descriptions(items, always_include_optional, process_additional_data)

    # ----------------------------------------------------------------------
    @classmethod
    def endpoints_methods_request_and_response_request_body(cls, item, always_include_optional, process_additional_data):
        if item in [DoesNotExist, None]:
            _endpoints_methods_request_and_response_request_body_TypeInfo.ValidateArity(None)
            return DoesNotExist

        result = cls._endpoints_methods_request_and_response_request_body_Item(item, always_include_optional, process_additional_data)

        if not process_additional_data:
            _endpoints_methods_request_and_response_request_body_TypeInfo.ValidateArity(result)

        return result

    # ----------------------------------------------------------------------
    @classmethod
    def endpoints_methods_request_and_response_responses(cls, items, always_include_optional, process_additional_data):
        if items in [DoesNotExist, None, []]:
            _endpoints_methods_request_and_response_responses_TypeInfo.ValidateArity(None)
            return DoesNotExist
        ...
        for this_index, this_item in enumerate(items or []):
            try:
                results.append(cls._endpoints_methods_request_and_response_responses_Item(this_item, always_include_optional, process_additional_data))
            except:
                _DecorateActiveException("Index {}".format(this_index))
        ...
        if not process_additional_data:
            _endpoints_methods_request_and_response_responses_TypeInfo.ValidateArity(results)

        return results

    # ----------------------------------------------------------------------
    @classmethod
    def endpoints_methods_request_and_response_responses_code(cls, item):
        if item in [DoesNotExist, None]:
            _endpoints_methods_request_and_response_responses_code_TypeInfo.ValidateArity(None)
            return DoesNotExist

        result = cls._endpoints_methods_request_and_response_responses_code_Item(item)

        _endpoints_methods_request_and_response_responses_code_TypeInfo.ValidateArity(result)

        return result

    # ----------------------------------------------------------------------
    @classmethod
    def endpoints_methods_request_and_response_responses_description(cls, item):
        if item in [DoesNotExist, None]:
            _endpoints_methods_request_and_response_responses_description_TypeInfo.ValidateArity(None)
            return DoesNotExist

        result = cls._endpoints_methods_request_and_response_responses_description_Item(item)

        _endpoints_methods_request_and_response_responses_description_TypeInfo.ValidateArity(result)

        return result

    # ----------------------------------------------------------------------
    @classmethod
    def endpoints_methods_request_and_response_responses_context(cls, item):
        return cls.endpoints_methods_request_and_response_context(item)

    # ----------------------------------------------------------------------
    @classmethod
    def endpoints_methods_request_and_response_responses_headers(cls, items, always_include_optional, process_additional_data):
        return cls.type_descriptions(items, always_include_optional, process_additional_data)

    # ----------------------------------------------------------------------
    @classmethod
    def endpoints_methods_request_and_response_responses_body(cls, item, always_include_optional, process_additional_data):
        if item in [DoesNotExist, None]:
            _endpoints_methods_request_and_response_responses_body_TypeInfo.ValidateArity(None)
            return DoesNotExist

        result = cls._endpoints_methods_request_and_response_responses_body_Item(item, always_include_optional, process_additional_data)

        if not process_additional_data:
            _endpoints_methods_request_and_response_responses_body_TypeInfo.ValidateArity(result)
    ...
    def _context_Item(cls, item):
        return YamlSerialization.DeserializeItem(_context_TypeInfo, item, **{})
    ...
    def _type_description_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # <fundamental value>
        try:
            fundamental_value = YamlSerialization.DeserializeItem(_type_description__value__TypeInfo, cls._GetPythonAttribute(
                item,
                "simple_schema",
                is_optional=False,
            )
    ...
    def _type_description_description_Item(cls, item):
        return YamlSerialization.DeserializeItem(_type_description_description_TypeInfo, item, **{})
    ...
    def _type_descriptions_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # <fundamental value>
        try:
            fundamental_value = YamlSerialization.DeserializeItem(_type_descriptions__value__TypeInfo, cls._GetPythonAttribute(
                item,
                "simple_schema",
                is_optional=False,
            )
    ...
    def _type_descriptions_name_Item(cls, item):
        return YamlSerialization.DeserializeItem(_type_descriptions_name_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _type_descriptions_description_Item(cls, item):
        return YamlSerialization.DeserializeItem(_type_descriptions_description_TypeInfo, item, **{})
    ...
    def _endpoints_Item(cls, item, always_include_optional, process_additional_data):
        ...
        if process_additional_data:
            cls._ApplyAdditionalData(
                item,
                result,
                exclude_names={"uri", "variables", "description", "group", "context", "methods", "children"},
            )
    ...
    def _endpoints_uri_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_uri_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_description_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_description_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_group_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_group_TypeInfo, item, **{})
    ...
    def _endpoints_methods_Item(cls, item, always_include_optional, process_additional_data):
        ...
        try:
            setattr(result, "request_and_response", cls.endpoints_methods_request_and_response(
                cls._GetPythonAttribute(
                    item,
                    "request_and_response",
                    is_optional=False,
            ...
            _DecorateActiveException("request_and_response")
        ...
        if process_additional_data:
            cls._ApplyAdditionalData(
                item,
                result,
                exclude_names={"verb", "summary", "description", "context", "request_and_response"},
            )
    ...
    def _endpoints_methods_verb_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_methods_verb_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_summary_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_methods_summary_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_description_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_methods_description_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_request_and_response_Item(cls, item, always_include_optional, process_additional_data):
        attributes = OrderedDict()

        # content_type
        try:
            attributes["content_type"] = cls.endpoints_methods_request_and_response_content_type(
                cls._GetPythonAttribute(
                    item,
                    "content_type",
                    is_optional=False,
        ...
        # context
        try:
            cls._ApplyOptionalChild(item, "context", result, cls.endpoints_methods_request_and_response_context, always_include_optional)
        except:
            _DecorateActiveException("context")

        # request
        try:
            setattr(result, "request", cls.endpoints_methods_request_and_response_request(
                cls._GetPythonAttribute(
                    item,
                    "request",
                    is_optional=False,
        ...
        # responses
        try:
            setattr(result, "responses", cls.endpoints_methods_request_and_response_responses(
                cls._GetPythonAttribute(
                    item,
                    "responses",
                    is_optional=False,
        ...
        if process_additional_data:
            cls._ApplyAdditionalData(
                item,
                result,
                exclude_names={"content_type", "context", "request", "responses"},
            )
        ...
        _endpoints_methods_request_and_response_TypeInfo.ValidateItem(
            result,
            recurse=False,
            require_exact_match=not process_additional_data,
        )
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_request_and_response_content_type_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_methods_request_and_response_content_type_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_request_and_response_request_Item(cls, item, always_include_optional, process_additional_data):
        result = _CreatePythonObject(
            attributes=None,
        )
        ...
        # headers
        try:
            cls._ApplyOptionalChildren(item, "headers", result, lambda value: cls.endpoints_methods_request_and_response_request_headers(value, always_include_optional, process_additional_data), always_include_optional)
        except:
            _DecorateActiveException("headers")

        # query_items
        try:
            cls._ApplyOptionalChildren(item, "query_items", result, lambda value: cls.endpoints_methods_request_and_response_request_query_items(value, always_include_optional, process_additional_data), always_include_optional)
        except:
            _DecorateActiveException("query_items")

        # form_items
        try:
            cls._ApplyOptionalChildren(item, "form_items", result, lambda value: cls.endpoints_methods_request_and_response_request_form_items(value, always_include_optional, process_additional_data), always_include_optional)
        except:
            _DecorateActiveException("form_items")

        # body
        try:
            cls._ApplyOptionalChild(item, "body", result, lambda value: cls.endpoints_methods_request_and_response_request_body(value, always_include_optional, process_additional_data), always_include_optional)
        except:
        ...
        _endpoints_methods_request_and_response_request_TypeInfo.ValidateItem(
            result,
            recurse=False,
            require_exact_match=not process_additional_data,
        )
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_request_and_response_request_body_Item(cls, item, always_include_optional, process_additional_data):
        attributes = OrderedDict()
        ...
        # <fundamental value>
        try:
            fundamental_value = YamlSerialization.DeserializeItem(_endpoints_methods_request_and_response_request_body__value__TypeInfo, cls._GetPythonAttribute(
                item,
                "simple_schema",
                is_optional=False,
            )
        ...
        _endpoints_methods_request_and_response_request_body_TypeInfo.ValidateItem(
            result,
            recurse=False,
            require_exact_match=not process_additional_data,
        )
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_request_and_response_responses_Item(cls, item, always_include_optional, process_additional_data):
        attributes = OrderedDict()

        # code
        try:
            attributes["code"] = cls.endpoints_methods_request_and_response_responses_code(
                cls._GetPythonAttribute(
                    item,
                    "code",
                    is_optional=False,
        ...
        # description
        try:
            cls._ApplyOptionalAttribute(item, "description", attributes, cls.endpoints_methods_request_and_response_responses_description, always_include_optional)
        except:
            _DecorateActiveException("description")
        ...
        # context
        try:
            cls._ApplyOptionalChild(item, "context", result, cls.endpoints_methods_request_and_response_responses_context, always_include_optional)
        except:
            _DecorateActiveException("context")

        # headers
        try:
            cls._ApplyOptionalChildren(item, "headers", result, lambda value: cls.endpoints_methods_request_and_response_responses_headers(value, always_include_optional, process_additional_data), always_include_optional)
        except:
            _DecorateActiveException("headers")

        # body
        try:
            cls._ApplyOptionalChild(item, "body", result, lambda value: cls.endpoints_methods_request_and_response_responses_body(value, always_include_optional, process_additional_data), always_include_optional)
        except:
            _DecorateActiveException("body")
        ...
        _endpoints_methods_request_and_response_responses_TypeInfo.ValidateItem(
            result,
            recurse=False,
            require_exact_match=not process_additional_data,
        )
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_request_and_response_responses_code_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_methods_request_and_response_responses_code_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_request_and_response_responses_description_Item(cls, item):
        return YamlSerialization.DeserializeItem(_endpoints_methods_request_and_response_responses_description_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _endpoints_methods_request_and_response_responses_body_Item(cls, item, always_include_optional, process_additional_data):
        attributes = OrderedDict()
        ...
        # <fundamental value>
        try:
            fundamental_value = YamlSerialization.DeserializeItem(_endpoints_methods_request_and_response_responses_body__value__TypeInfo, cls._GetPythonAttribute(
                item,
                "simple_schema",
                is_optional=False,
            )
        ...
        _endpoints_methods_request_and_response_responses_body_TypeInfo.ValidateItem(
            result,
            recurse=False,
            require_exact_match=not process_additional_data,
        )
